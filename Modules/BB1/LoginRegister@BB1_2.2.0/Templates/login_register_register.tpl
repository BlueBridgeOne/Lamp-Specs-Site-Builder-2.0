...
{{/unless}}
	...
	<div class="login-register-register-form-controls-group">
		<label class="login-register-register-form-label">
			...
			{{translate 'Please send me the occasional voucher code and product news.'}}
		</label>
	</div>

		<div class="login-register-register-form-controls-group">
		<label class="login-register-register-form-label">
			<input  type="checkbox" name="emailunsubscribe" id="register-emailunsubscribe" value="T" >
			{{translate 'Do not send me occasional voucher codes nor product news.'}}
		</label>
	</div>
	<p><small>We will use your data to limit contact to relevant products.</small></p>
